        ...
        if (this.getEventDocument() == null) {
            ...
            try {
                ...
                while(var8.hasNext()) {
                    ...
                    doc.commit();
                    importLog.add("IMPORTED FOR : " + FolderName);
                    importLog.add("IMPORTED FOR : " + docType);
                    importLog.add("IMPORTED FOR : " + filePath);
                    log.info("GIBDoc Imported Doc ID : " + doc.getID());

                }
                this.log.info("Import GIBDoc from Excel Finished");
                writeLogToFile(importLog, "importLog.txt");
